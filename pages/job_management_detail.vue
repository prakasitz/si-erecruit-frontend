<template>
    <div>
        <TopicBar
            :labels="[{ title: 'หนัาหลัก', href: '/' }, { title: 'จัดการงาน', to: '/job_management' }, 'รายละเอียดงาน']" />
        ...
        <v-card class="mx-auto my-5" width="90%">
            ...
            <v-card-text class="d-flex justify-center">
                <v-data-table v-model:items-per-page="itemsPerPage" :headers="headers" :items="data" item-value="name"
                    class="elevation-0" show-select>
                    <template v-slot:top>
                    </template>
